...
const Privacy: React.FC = () =>
{
  return (
    <div className="min-h-screen bg-rosa-ivory">
      ...
      {/* Contenu (exemple générique, inchangé si tu avais un texte) */}
      <section className="py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white rounded-2xl p-6 md:p-10 shadow-sm">
          <h2 className="text-2xl md:text-3xl font-playfair font-bold text-rosa-warm-gray mb-4">Collecte des données</h2>
          <p className="font-inter text-rosa-warm-gray/80 mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-playfair font-bold text-rosa-warm-gray mb-4">Utilisation</h2>
          <p className="font-inter text-rosa-warm-gray/80 mb-6">
            Vos données sont utilisées pour la gestion des réservations, la communication et l’amélioration de nos prestations.
          </p>

          <h2 className="text-2xl md:text-3xl font-playfair font-bold text-rosa-warm-gray mb-4">Sécurité</h2>
