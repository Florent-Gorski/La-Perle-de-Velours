            ...
            {packages.map((pkg, index) => (
              <div
                ...
                className={`relative bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 ${
                  pkg.popular ? 'ring-2 ring-rosa-honey md:scale-105' : ''
                }`}
              >
                {pkg.popular && (
                ...
                <div className="p-6 md:p-8">
                  ...
                  <a
                    href="/contact"
                    className={`w-full block text-center py-4 px-6 rounded-full font-inter font-medium transition-colors min-h-[48px] flex items-center justify-center ${
                      pkg.popular
